      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {!isEditing && (
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-full border border-border text-sm">
              <Checkbox
              ...
              <span className={!substackConnected ? "text-muted-foreground" : ""}>
                Substack
              </span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-full border border-border text-sm">
              ...
              <span className={!threadsConnected ? "text-muted-foreground" : ""}>
                Threads
              </span>
            </label>
          </div>
